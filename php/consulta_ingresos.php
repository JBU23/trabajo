<?php
    ...
    if ($resultado = mysqli_query($conexion, $sql)){
        ...
        while ($registro = mysqli_fetch_assoc($resultado)){
            echo "<tr>";
            echo "<td style='width: 10%;'>" . $registro["ing_id"] . "</td>";
            echo "<td style='width: 40%;'>" . $registro["ing_descripcion"] . "</td>";
            echo "<td style='width: 25%; text-align: right;'>" . number_format($registro["ing_cantidad"],2) . "</td>";
            echo "<td style='width: 25%;'>" . $registro["ing_fecha"] . "</td>";
            echo "</tr>";
            $total += $registro["ing_cantidad"];
        }
        echo "<tr>";
        echo "<td></td>";
